    ...
    <section id="contact" className="section-luxury">
      <div className="max-w-6xl mx-auto">
        <ScrollReveal>
          <div className="text-center mb-16">
            ...
            <h2 className="section-heading text-foreground mb-2">
              {t.contact.title} <span className="italic text-primary font-medium">{t.contact.titleHighlight}</span>
            </h2>
        ...
        <ScrollReveal delay={0.2}>
          <div className="rounded-2xl overflow-hidden h-96 border border-border/50">
            <iframe
